...
export const useAnalyticsStore = defineStore('analytics', {
  ...
  actions: {
    async fetchChartsData(from, to) {
      ...
      try {
        const response = await $fetch(`https://cors-anywhere.herokuapp.com/https://jsonplaceholder.leadsbounty.com/analytics?from=${from}&to=${to}`, {
          headers: {
    ...
    async NewFollowersData() {
      ...
      try {
          const response = await $fetch(`https://cors-anywhere.herokuapp.com/https://jsonplaceholder.leadsbounty.com/followers`, {
              headers: {
                'Content-Type': 'application/json',
              }
            });
    ...
    async LastActivityData() {
      ...
      try {
          const response = await $fetch(`https://cors-anywhere.herokuapp.com/https://jsonplaceholder.leadsbounty.com/activities`, {
              headers: {
                'Content-Type': 'application/json',
              }
            });
