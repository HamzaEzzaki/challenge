...
<template>
    ...
    const chartOptions = computed(() => ({
        ...
        plotOptions: {
            bar: {
                borderRadius: 15, // Default borderRadius
                columnWidth: '58%',
        ...
        responsive: [
            ...
            {
                breakpoint: 600, // Breakpoint for very small screens (e.g., mobile phones)
                options: {
                    plotOptions: {
                        bar: {
                            borderRadius: 6, // Even smaller borderRadius for screens < 480px
                        }
                    }
                }
            }
